...
class UserManager(models.Manager):
    def addUser(self, person):
        response = {}
        errors = []
        if person['name'] == "" or person['username'] =="" or person["password"] == "" or person['confirm_pw'] =="":
        ...
        if errors:
            ...
            response['person'] = User.objects.create(name=person["name"], username=person["username"], password =hashed_pw, salt=salt)
        return response
